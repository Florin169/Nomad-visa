...
interface HomeClientWrapperProps {
  initialCountries: VisaCountry[];
}

export default function HomeClientWrapper({ initialCountries }: HomeClientWrapperProps) {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-xs font-medium text-blue-300">
                Updated {currentMonth} {currentYear} · Digital Nomad Visa Requirements for {initialCountries.length} Countries
              </span>
            </div>
            ...
            <p className="text-base text-zinc-400 max-w-xl mx-auto leading-relaxed mb-10">
              Compare digital nomad tax rates, minimum income requirements, and residency paths with mathematical transparency. Get real-time {currentYear} data on visa processing times and required documents for {initialCountries.length} top-tier destinations.
            </p>
        ...
        >
          {[
            { label: "Visa programs tracked", value: initialCountries.length.toString() },
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {[
              ...
              const ca = initialCountries.find((c) => c.id === a)!;
              const cb = initialCountries.find((c) => c.id === b)!;
              return (
                <a
                  key={`${a}-${b}`}
                  href={`/compare/${a}-vs-${b}`}
